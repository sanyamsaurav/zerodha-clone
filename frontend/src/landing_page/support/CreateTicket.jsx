  ...
  <div className='container '>
    <div className='row p-5 mb-5 mt-5'>
      ...
      <div className='col-12 col-md-4 p-5 mt-2 mb-2'>
        ...
        <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Login Credential</a>
        <br />
      ...
      <div className='col-12 col-md-4 p-5 mt-2 mb-2'>
        ...
        <br />
        <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>segment</a>
        <br />
        <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>eMandates</a>
      ...
      <div className='col-12 col-md-4 p-5 mt-2 mb-2'>
        ...
        <br />
        <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Fixed Deposite</a>
        <br />
